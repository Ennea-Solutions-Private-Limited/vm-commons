...
@Data
@JsonRootName(value = "GetAccountStatementResponse")
public class GasResponseDTO {

    @JsonProperty("SubHeader")
    private SubHeaderDTO subHeaderDTO;

    @JsonProperty("GetAccountStatementResponseBodyEncrypted")
    private String getAccountStatementResponseBodyEncrypted;
}
